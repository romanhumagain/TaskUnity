  ...
  return (
    <>
      <div className="text-gray-900 bg-gray-100 dark:text-gray-100 dark:bg-neutral-900 min-h-screen w-full py-5 px-2 border-r-2 border-gray-200 dark:border-neutral-600">
        ...
        <div className="bg-gray-200 text-gray-800 dark:bg-neutral-900/20 dark:text-gray-200 py-3 px-2 mt-5 rounded-xl">
        ...
        <div className="px-5">
          ...
          <div className="mt-4">
            <p className="font-semibold text-md text-gray-900 dark:text-neutral-300 flex items-center gap-1"><CiViewList />Todo</p>
